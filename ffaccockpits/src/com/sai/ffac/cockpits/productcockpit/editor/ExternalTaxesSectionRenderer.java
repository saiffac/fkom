 ...
 *  
 */
package com.sai.ffac.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("ffaccockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("ffaccockpits.product.externalTaxes"));
