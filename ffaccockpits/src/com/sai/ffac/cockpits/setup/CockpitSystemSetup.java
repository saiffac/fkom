 ...
 *  
 */
package com.sai.ffac.cockpits.setup;
...
import com.sai.ffac.cockpits.constants.FfacCockpitsConstants;
 ...
 */
@SystemSetup(extension = FfacCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(FfacCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(FfacCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						FfacCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/ffaccockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}
