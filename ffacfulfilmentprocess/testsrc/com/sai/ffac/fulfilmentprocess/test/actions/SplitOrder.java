 ...
 *  
 */
package com.sai.ffac.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(FfacFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(FfacFulfilmentProcessConstants.PARENT_PROCESS);
