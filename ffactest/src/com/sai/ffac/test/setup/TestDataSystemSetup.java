 ...
 *  
 */
package com.sai.ffac.test.setup;
...
import com.sai.ffac.test.constants.FfacTestConstants;
import com.sai.ffac.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = FfacTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ffactest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ffactest/import/reviews.impex");
			...
			importImpexFile(context, "/ffactest/import/cstickets.impex");
		}
	}
}
