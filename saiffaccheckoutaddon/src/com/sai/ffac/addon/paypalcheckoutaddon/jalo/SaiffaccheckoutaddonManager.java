 ...
 *  
 */
package com.sai.ffac.addon.paypalcheckoutaddon.jalo;
...
import com.sai.ffac.addon.paypalcheckoutaddon.constants.SaiffaccheckoutaddonConstants;



/**
 * This is the extension manager of the Saiffaccheckoutaddon extension.
 */
public class SaiffaccheckoutaddonManager extends GeneratedSaiffaccheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SaiffaccheckoutaddonManager.class.getName());
	 ...
	 */
	public static SaiffaccheckoutaddonManager getInstance()
	{
		return (SaiffaccheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SaiffaccheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SaiffaccheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SaiffaccheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SaiffaccheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SaiffaccheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
