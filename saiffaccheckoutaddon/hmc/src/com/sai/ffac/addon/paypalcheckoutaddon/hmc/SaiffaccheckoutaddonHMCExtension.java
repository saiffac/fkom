 ...
 *  
 */
package com.sai.ffac.addon.paypalcheckoutaddon.hmc;
...
/**
 * Provides necessary meta information about the saiffaccheckoutaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.2.0.0
 */
public class SaiffaccheckoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SaiffaccheckoutaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.sai.ffac.addon.paypalcheckoutaddon.hmc.locales";
